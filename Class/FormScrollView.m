...
- (void)drawRect:(CGRect)rect {
    ...
    if (_columnTitle.length!=0 && _sectionTitle.length!=0) {
        ...
        [_columnTitle drawInRect:CGRectMake(0, 0, CGRectGetWidth(rect), CGRectGetHeight(rect)) withAttributes:attributrs];
        CGContextStrokePath(context);
        
        [_sectionTitle drawInRect:CGRectMake(0,0, CGRectGetWidth(rect), CGRectGetHeight(rect)) withAttributes:attributrs];
